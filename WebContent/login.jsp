...
<head>
  ...
  <title>Login to StudentMate</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2"><strong>Welcome to StudentMate</strong></h3>
    ...
    <div class="container">
        <div class="row content-wrapper justify-content-center">
            <div class="col-lg-3 offset-lg-1 mbr-form" data-form-type="formoid">
                <form action="login" method="post" class="mbr-form form-with-styler">
                    <div class="dragArea row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                              <%
								...
								%>
								<%
								String reg_msg=(String)request.getAttribute("accCreated");  
								if(reg_msg!=null)
								out.println("<p align= center><font color=red size=4px>"+reg_msg+"</font></p>");
								%>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <p class="mbr-text mbr-fonts-style mb-4 display-7">
                                Sign to StudentMate</p>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                        	<p class="mbr-text mbr-fonts-style mb-4 display-7"><a href="Forget.jsp">Reset Password! </a><a href="Signup.jsp">Signup here</a></p>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                        	<p class="mbr-text mbr-fonts-style mb-4 display-7"><a href="AdminLogin.jsp">Click here for Admin login</a></p>
                        </div>
                    </div>
                </form>
            </div>
